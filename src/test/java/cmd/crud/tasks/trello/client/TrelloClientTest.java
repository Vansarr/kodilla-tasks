package cmd.crud.tasks.trello.client;
...
import cmd.crud.tasks.trello.config.TrelloConfig;
...
class TrelloClientTest {
    ...
    public void shouldReturnEmptyList() throws URISyntaxException {
        ...
        //When
        List<TrelloBoardDto> emptyBoardList = trelloClient.getTrelloBoards();
        //Then

        assertEquals(0, emptyBoardList.size());
